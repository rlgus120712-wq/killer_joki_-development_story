        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-3xl mx-auto">
            ...
            <span className="text-primary-400 font-semibold">
              React 18 + Vite 6 + TypeScript 5 + Tailwind CSS 3 + Framer Motion 11
            </span>
          </p>
        </motion.div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Vite의 초고속 HMR과 React 18의 최신 기능으로
                    개발 생산성을 극대화했습니다.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    GitHub Pages와 GitHub Actions로 무료 호스팅 및
                    자동 배포를 구현했습니다.
                  </p>
                </div>
              </div>
